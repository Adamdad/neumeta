...
def main():
    ...
    for imp_name, imp in imp_dict.items():
        ...
        with open(f"pruning_results_{model_name}_{imp_name}_fashionmnist.txt", "w") as results_file:
            ...
            for pruning_ratio in [i * 0.05 for i in range(20)]:  # Adjust the range/sequence as needed
                ...
                model.load_state_dict(torch.load(f"toy/fashionmnist_{model.__class__.__name__}_dim{hidden_dim}.pth"))
